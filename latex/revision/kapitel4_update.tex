...
Die Anwendung ist für die Nutzung im Hochformat konfiguriert. Benötigt werden ein Touchscreen, eine ausreichende Darstellung von Vollbildbildern und Textoptionen sowie eine Internetverbindung für Infofeed, Aktivierung, Datenschutzstatus, Feature-Freigabe, Feedback und wissenschaftliche Selbstberichte. Eine Kamera ist für die aktuelle produktive Studienfassung nicht erforderlich, weil die Studienaufgaben statische Ressourcen verwenden. Sie würde erst für eine spätere KI-gestützte Klassifikation selbst gewählter Bilder relevant.
...
Die Produktionsvariante verwendet ausschließlich HTTPS und verbietet unverschlüsselten Klartextverkehr in der Android-Konfiguration. Die Staging-Variante darf für eine abgegrenzte lokale Testumgebung HTTP verwenden. Diese Trennung verhindert, dass eine Testadresse oder eine unsichere Transportkonfiguration versehentlich in den Produktions-Build übernommen wird.
...
Der App-Token wird mit einem 256-Bit-AES-Schlüssel im GCM-Modus verschlüsselt. Der Schlüssel wird über den Android Keystore verwaltet. Diese Funktion steht auf allen unterstützten Geräten grundsätzlich zur Verfügung, kann aber durch Herstellerimplementierung, Gerätezustand oder eine beschädigte Schlüsseldatenbank beeinträchtigt werden. Kann der Schlüssel nicht mehr geladen werden oder schlägt die Authentizitätsprüfung des Chiffrats fehl, verwendet die App den Token nicht und fordert einen Supportvorgang statt einer unsicheren Wiederherstellung.
...
Erinnerungen an die nächste Studiensituation werden als einmalige, eindeutige Aufgaben über WorkManager geplant. Auch diese Aufgaben sind nicht sekundengenau. Die App prüft beim Ausführen erneut die gespeicherte Freigabezeit. Wird ein Worker zu früh gestartet, wird er für die verbleibende Zeit neu eingeplant. Damit kann eine Erinnerung verspätet, aber nicht absichtlich vor Ablauf der Sperrzeit angezeigt werden.

Für die Studienmethodik folgt daraus, dass Benachrichtigungen lediglich unterstützend wirken. Die dreistündige Sperrzeit wird durch den gespeicherten Studienzustand und nicht durch den Benachrichtigungszeitpunkt bestimmt. Teilnehmende müssen die App auch ohne rechtzeitig zugestellte Erinnerung verwenden können.

\section{Installation und Aktualisierung}

Die App wird derzeit als APK über die Studienwebseite verteilt. Die Installationsseite ist für Android 7.0 oder neuer ausgewiesen und enthält getrennte deutsche und englische Schrittfolgen mit Screenshots. Je nach Browser, Gerätehersteller und Android-Version können Dateidownload, Paketprüfung und Freigabe einer Installation aus unbekannter Quelle unterschiedlich dargestellt werden. Für die Teilnahme ist daher eine nachvollziehbare Anleitung und ein erreichbarer technischer Support erforderlich.

Die direkte APK-Verteilung bietet keine automatische Aktualisierung über einen App-Store. Wird während der Studie eine neue Version erforderlich, müssen Teilnehmende aktiv informiert und durch die Installation geführt werden. Gleichzeitig darf ein Update den lokalen Token und Studienfortschritt nicht unbeabsichtigt löschen. Vor jeder produktiven Aktualisierung sind deshalb Installation über eine bestehende Version, Erhalt der privaten App-Daten und Kompatibilität der lokalen Speicherformate zu testen.
