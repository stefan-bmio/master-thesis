...
Für den aktuellen Prototyp wird diese Struktur nicht als vollständig automatisierte Reizerkennung, sondern als kuratierter Stimulus- und Antwortpool umgesetzt. Die Cue-Matching-Bildzuordnungen und die Cue-Labeling-Wortpaare wurden mit starker KI-Unterstützung erstellt, anschließend manuell gesichtet und als statische Ressourcen beziehungsweise als fest codierte Zuordnungsliste in die App übernommen. Damit handelt es sich um eine prototypische Operationalisierung des in der Laborarbeit beschriebenen Cue-Labeling-Prinzips und nicht um einen validierten semantischen Normdatensatz \cite{tabibnia_cuelabeling_2026}. Pro Cue werden ein besser passendes und ein weniger passendes Label gespeichert; dieselbe Grundlogik wird bei den Bildzuordnungen im Cue-Matching verwendet. Diese Entscheidung reduziert den Entwicklungsaufwand, vermeidet die Verarbeitung selbst aufgenommener Alltagsbilder im Studienbetrieb und macht die Aufgaben reproduzierbar. Gleichzeitig begrenzt sie die Aussagekraft: Ein beobachteter Effekt wäre zunächst nur für den verwendeten prototypischen Stimuluspool interpretierbar. Für eine spätere Wirksamkeitsstudie mit höherem Anspruch müssten Label- und Bildpassungen zusätzlich durch unabhängige Ratings oder eine Pilotierung abgesichert werden.
