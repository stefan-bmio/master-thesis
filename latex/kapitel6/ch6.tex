...
Geplant ist eine quantitative Pilotstudie mit Primärdatenerhebung und Within-Subject-Design. Alle Teilnehmenden erhalten die gleichen Aufgaben, die sowohl Cue-Matching als auch Cue-Labeling einschließen. Die App führt die Teilnehmenden über einen Zeitraum von bis zu zwei Wochen durch 20 Studiensituationen. In jeder Studiensituation werden fünf Bilder mit Auslöserreizen gezeigt. Anschließend ordnen die Teilnehmenden entweder dem Bild ein anderes rauchbezogenes Bild zu, oder sie wählen eine Beschreibung des gezeigten Auslöserreizes. Nach der Aufgabenbearbeitung wird das aktuelle Rauchverlangen auf der Skala von 0~bis~100 abgefragt. Es sind insgesamt 50 Zuordnungen im Cue-Matching, 50 Zuordnungen im Cue-Labeling und 20 Selbstberichte zum Rauchverlangen vorgesehen.

Die Bildpaare für Cue-Matching und die Wortpaare für Cue-Labeling wurden mit starker KI-Unterstützung erzeugt und anschließend manuell in den Prototyp übernommen. Diese Operationalisierung ist für die technische Umsetzung und eine Pilotierung geeignet, weil sie die Stimuli vollständig reproduzierbar macht und keine personenbezogenen Alltagsbilder der Teilnehmenden benötigt. Sie ist jedoch nicht als unabhängig validierte Reiznormierung zu verstehen. Für die spätere Interpretation wird deshalb dokumentiert, welche Cue-Bilder, Vergleichsbilder und Labeloptionen verwendet wurden. Wenn die Studie Hinweise auf einen Unterschied zwischen den Bedingungen liefert, muss dieser Befund in einer Folgeuntersuchung mit unabhängig bewerteten Reiz- und Labelpassungen abgesichert werden \cite{tabibnia_cuelabeling_2026}.
...
Angelehnt an das Laborexperiment treten beide Aufgabentypen gleich oft auf. Praktisch wird das durch zwei vorbereitete Listen mit jeweils 10 Studiensituationen umgesetzt. Die erste Liste enthält Studiensituationen für Cue-Matching und die zweite Liste Studiensituationen für Cue-Labeling. Innerhalb der Cue-Matching-Liste erzeugt die App eine zufällige Reihenfolge der Bildaufgaben und speichert diese lokal, damit die Reihenfolge über App-Neustarts hinweg stabil bleibt. Außerdem werden die beiden Antwortoptionen bei Cue-Matching und Cue-Labeling zufällig links beziehungsweise rechts angezeigt. Dadurch werden Positionspräferenzen reduziert. Die Blockreihenfolge Cue-Matching vor Cue-Labeling bleibt im Prototyp aus Gründen der technischen Einfachheit festgelegt. Das ist methodisch als Limitation zu berücksichtigen, weil Reihenfolge-, Gewöhnungs- und Zeiteffekte nicht vollständig von Bedingungseffekten getrennt werden können.

Diese Vorgehensweise kommt ohne serverseitige Sitzungssteuerung aus, und der individuelle Fortschritt wird lokal gespeichert. Für eine auswertbare Studiendatenbank müssen die übermittelten Selbstberichte dennoch eindeutig einem Durchgang, einer Bedingung und einem pseudonymen Teilnahmekontext zugeordnet werden können. Die aktuelle Entwicklungsfassung übermittelt nur den Craving-Wert. Vor Beginn der Auswertung muss daher entweder die App-Übertragung um einen pseudonymen Token, den Durchgangsindex und die Bedingung ergänzt werden oder der Server muss diese Informationen aus einem verlässlichen technischen Zähler rekonstruieren können.
...
Die Rekrutierung kann über Online-Plattformen, thematisch passende Online-Communities sowie Flyer oder Aushänge in Apotheken, Arztpraxen und Beratungsstellen erfolgen. Es werden Adresslisten aus dem Suchthilfeverzeichnis der Deutschen Hauptstelle für Suchtfragen\footnote{https://www.suchthilfeverzeichnis.de} und aus dem Suchtindex der Schweizerischen Koordinations- und Fachstelle Sucht\footnote{https://suchtindex.infodrog.ch} extrahiert. Die Adressen werden händisch auf die zur Verfügung stehende Anzahl der gedruckten Flyer reduziert. An die Adressen werden E-Mails mit der Webadresse der Studiendokumentation, der Datenschutzerklärung und des Flyers sowie Briefe mit dem gedruckten Flyer versendet. Die Sendungen enthalten jeweils die Bitte, den Flyer sichtbar auszuhängen und auf Wunsch zu vervielfältigen. Die Liste der Adressen ist im Anhang \ref{adressen}, der Flyer im Anhang \ref{flyer}, die Studiendokumentation im Anhang \ref{studieninformation} und die Datenschutzerklärung im Anhang \ref{datenschutzerklaerung} zu finden.
