...
Der Name der Studie ist CueLens. Der Name wird nicht als Marke eingetragen. In deutschen (DPMA), schweize\-rischen (IGE), europäischen (EUIPO) und globalen (WIPO) Markenregistern sowie im Google Play Store wurden zum Suchbegriff "`CueLens"' keine bestehende Einträge gefunden.
