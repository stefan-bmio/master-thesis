...
\newcommand{\insertrevisionatnextnewpage}[1]{%
  \let\revisionOriginalNewpage\newpage
  \def\newpage{%
    \let\newpage\revisionOriginalNewpage
    \input{#1}%
    \revisionOriginalNewpage
  }%
}

\input{einführung/einführung.tex}
\insertrevisionatnextnewpage{revision/kapitel1_update.tex}
\input{kapitel1/ch1.tex}
\let\newpage\revisionOriginalNewpage
\input{kapitel2/ch2.tex}
\input{revision/kapitel2_update.tex}
\insertrevisionatnextnewpage{revision/kapitel3_update.tex}
